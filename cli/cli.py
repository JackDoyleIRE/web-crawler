...
class CLI:
    def __init__(self):
        self.logger = Logger(level='INFO')  # Default log level is info
    ...
    def start(self):
        ...
        while True:
            ...
            if choice == '1':
                ...
                # Start the crawl and store the returned links
                result_links = self.crawler.crawl(start_url, max_depth, clean_links=True)
